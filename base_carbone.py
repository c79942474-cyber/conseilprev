...
fichier, parce que le réflexe inverse est naturel et il serait faux.
  ...
  des pays, décembre 2019 pour six d'entre eux. Confrontés aux moyennes
  annuelles Ember 2024 employées par le module d'empreinte, l'écart est
  considérable : France 45 contre 79,1 (−43 %), Allemagne 355 contre 461
  (−23 %), Estonie 415 contre 1010 (−59 %).
  ...
  français s'énoncerait « +76 % » au lieu de « −43 % » — les deux sont exacts,
