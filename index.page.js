...
function applyLang(){
  ...
  // L'infobulle est un ATTRIBUT, pas du texte : la boucle [data-i18n]
  // ci-dessus ne la voit pas, et elle resterait française en EN et en DE.
  document.querySelectorAll('[data-i18n-tip]').forEach(function(el){
    var v=ii(el.dataset.i18nTip);if(v)el.setAttribute('data-tooltip',v);
  });
