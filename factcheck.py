...
CONTROLES.append({
    ...
    "constat": "Mesuré par comparaison des deux tables, août 2026 : 28 des 29 pays "
               "communs divergent — écart MÉDIAN 9,0 %, moyen 12,8 %, maximum "
               "50 % (France 45 contre 56, Finlande 65 contre 79, Chypre 510 "
               "contre 600). Les deux tables citent la MÊME source primaire — "
               "Ember — mais deux millésimes : empreinte_sites.py retient 2024 en "
               "approche cycle de vie, datacenter.py retient 2023-2024 en approche "
               "location-based, recoupée avec l'Agence européenne pour "
               "l'environnement. L'écart n'est donc pas une erreur de saisie mais "
               "une divergence de millésime et de périmètre — les réseaux "
               "européens se décarbonent vite, et un an d'écart suffit à produire "
               "24 % sur la France. "
               "CE QUI CHANGE UNE DÉCISION, CE N'EST PAS L'ÉCART MAIS LE RANG. "
               "Classés du plus propre au plus émetteur, les QUATRE PREMIERS sont "
               "les mêmes des deux côtés et à la Base Carbone ADEME (Norvège, "
               "Suède, France, puis Finlande ou Lettonie) : le conseil d'ensemble "
               "tient. Deux pays font exception et ils sont nommés ici plutôt que "
               "lissés — le LUXEMBOURG passe du 15e rang à Sentinel au 6e à Cyber "
               "(220 contre 110 gCO2e/kWh), neuf places, quand l'ADEME le place "
               "17e à 410 ; la LETTONIE passe du 12e au 7e (170 contre 110), et "
               "c'est là Sentinel qui s'écarte, l'ADEME donnant 120. Les deux "
               "maisons se trompent donc chacune une fois, en sens inverse. Tant "
               "qu'un gestionnaire de réseau n'a pas tranché, une implantation "
               "envisagée au Luxembourg ou en Lettonie ne doit PAS être arbitrée "
               "sur ce facteur seul. "
               "AUCUNE DES DEUX TABLES N'EST FAUSSE EN BLOC ; ce qui manquait, "
               "c'est que le lecteur puisse le savoir. Un client qui compare deux "
               "livrables du même cabinet doit trouver ici la raison de l'écart, "
               "et non le découvrir en réunion. "
               "RÉSERVE SUR CE CONSTAT LUI-MÊME : la version d'hier annonçait "
               "« 12,1 % en moyenne ». Re-mesuré, aucun dénominateur défendable ne "
               "redonne ce chiffre — c'est 12,8 % en rapportant l'écart à la "
               "valeur Sentinel sur les 29 pays communs. Le chiffre était faux, il "
               "est corrigé, et un contrôle automatique le re-mesure désormais "
               "quand les deux dépôts sont côte à côte.",
