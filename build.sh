...
# contient pas, et le module `qualification_moteur` se repliait donc sur
# l'API Messages. Ce script installe l'exécutable pour que le SDK serve
# réellement en ligne.
#
...
# binaire de 92 Mo n'a pas pu être téléchargé : la qualification assistée a un
# repli qui fonctionne, le reste du site n'a pas de repli du tout. Seul
# `pip install` peut faire échouer ce script, exactement comme avant.
#
